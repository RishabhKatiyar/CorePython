...
class TestInternalServices(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_successful_booking(self):
        ...
        response = self.bookingService.BookRoom(_input.Query, self.meetingRooms)
    ...
    def test_vacancy(self):
        ...
        response = self.vacancyService.GetVacancy(_input.Query, self.meetingRooms)
